...
int32_t confgenerator_serialize_mcconf(uint8_t *buffer, const mc_configuration *conf) {
	...
	buffer_append_float32_auto(buffer, conf->m_dual_encoder_drive_teeth, &ind);
	buffer_append_float32_auto(buffer, conf->m_dual_encoder_driven_teeth, &ind);
	buffer_append_float32_auto(buffer, conf->m_dual_encoder_motor_ratio, &ind);
	buffer[ind++] = conf->m_dual_encoder_dir;
...
bool confgenerator_deserialize_mcconf(const uint8_t *buffer, mc_configuration *conf) {
	...
	conf->m_dual_encoder_drive_teeth = buffer_get_float32_auto(buffer, &ind);
	conf->m_dual_encoder_driven_teeth = buffer_get_float32_auto(buffer, &ind);
	conf->m_dual_encoder_motor_ratio = buffer_get_float32_auto(buffer, &ind);
	conf->m_dual_encoder_dir = buffer[ind++];
...
void confgenerator_set_defaults_mcconf(mc_configuration *conf) {
	...
	conf->m_dual_encoder_drive_teeth = MCCONF_M_DUAL_ENCODER_DRIVE_TEETH;
	conf->m_dual_encoder_driven_teeth = MCCONF_M_DUAL_ENCODER_DRIVEN_TEETH;
	conf->m_dual_encoder_motor_ratio = MCCONF_M_DUAL_ENCODER_MOTOR_RATIO;
	conf->m_dual_encoder_dir = MCCONF_M_DUAL_ENCODER_DIR;
}
